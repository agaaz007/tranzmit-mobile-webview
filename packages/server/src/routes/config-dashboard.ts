...
<body>
  ...
  <script>
    ...
    function composePreviewDocument(spec) {
      return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>' + (spec.document && spec.document.css || '') + '</style></head><body>' + (spec.document && spec.document.html || '') + '</body></html>';
    }
